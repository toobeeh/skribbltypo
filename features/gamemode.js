    ...
    modes: [
        {
            ...
            options: {
                ...
                observeAction: () => {
                    ...
                    QS("#game-chat .container style#gamemodeDeafRules").innerHTML =
                        ...
                        "" : "#game-chat .container .content > p > span:not(:empty) {filter: grayscale(1) blur(4px) opacity(0.8);} #game-word {opacity:0}";
                }
            }
        }, {
            name: "One Shot",
            ...
            options: {
                ...
                observeAction: () => {
                    const itemWidth = getComputedStyle(QS("#game-toolbar > div.color-picker > div.colors > div > div")).width;
                    const itemCount = QS("#game-toolbar > div.color-picker > div.colors > div").children.length;
                    ...
                    QS("#game-toolbar style#gamemodeMonochromeRules").innerHTML =
                        ...
                        `#game-toolbar > div.color-picker > div.colors > div > div.item:not(:nth-child(${randomIndex}))
                            {display:none;}
                         #randomColor, #colPicker{display:none;}
