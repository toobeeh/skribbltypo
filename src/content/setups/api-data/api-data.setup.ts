import { AnnouncementsApi, EmojisApi, ScenesApi, SpritesApi } from "@/api";
 ...
 */
function getData(spritesApi: SpritesApi, scenesApi: ScenesApi, emojisApi: EmojisApi, announcementsApi: AnnouncementsApi) {
  return {
