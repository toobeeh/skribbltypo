...
<div>
  <p>
    ...
    By default, aa performance mode is activated. This mode is recommended for devices with lower performance.<br>
  ...
  <b>Attention!</b>
  <p>
    You need to disable skribbl pressure in the skribbl settings to make typo pressure work.
  </p>
  <br>
