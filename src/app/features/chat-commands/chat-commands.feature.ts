...
import { type CommandExecutionResult } from "@/app/core/commands/commands.service";
import { StringCommandParameter } from "@/app/core/commands/params/string-command-parameter";
import {
  InterpretableArgumentParsingError
} from "@/app/core/commands/results/interpretable-argument-parsing-error";
import { InterpretableDeferResult } from "@/app/core/commands/results/interpretable-defer-result";
import { InterpretableCommandPartialMatch } from "@/app/core/commands/results/interpretable-command-partial-match";
