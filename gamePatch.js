        ...
        if (0 < e.data.length) {
          ...
          for (var h = 0; h < 3; h++) {
            ...
            if (0 < p.length) {
              ...
              for (o = 0; o < p.length; o++) ge(S = he((s = p[o]).player.avatar, f), Ra(s.player)), S.style.left = 15 * -(p.length - 1) + 30 * o + "%", 0 == h && (S.classList.add("winner"), S.style.animationDelay = -2.35 * o + "s"), l.appendChild(S)
            }
          }
